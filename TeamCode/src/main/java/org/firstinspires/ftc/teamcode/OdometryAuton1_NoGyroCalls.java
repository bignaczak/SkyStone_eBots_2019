...
public class OdometryAuton1_NoGyroCalls extends eBotsOpMode2019 {
    ...
    private Double saturationLimit = 0.65;
    ...
    public void runOpMode(){
        ...
        //while(opModeIsActive() && currentPose.getErrorControlValue() > 0.5 && loopCount < 5000 && currentPose.getErrorSum() == 0.0 ){
